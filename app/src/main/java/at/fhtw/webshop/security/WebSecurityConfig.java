    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/","/uploads/**","/api/products/**","/api/categories/**","/products/**", "/favicon.ico", "/logo.png","/auth/**", "/api/auth/**", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/error**", "/scripts/**", "/css/**")
                        .permitAll()
